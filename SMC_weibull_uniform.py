...
credible_interval_shape = np.percentile(shape_samples, [2.5, 97.5])
credible_interval_scale = np.percentile(scale_samples, [2.5, 97.5])
credible_interval_location = np.percentile(location_samples, [2.5, 97.5])
