...
credible_interval_means = np.percentile(mean_samples, [2.5, 97.5], axis=0)
credible_interval_std_devs = np.percentile(std_dev_samples, [2.5, 97.5], axis=0)
credible_interval_weights = np.percentile(weights_samples, [2.5, 97.5], axis=0)
